export const Icons = {
  ...
  deb: {
    paths: [
      {
        d: "M12 2C9.789 2 8 3.789 8 6C8 8.211 9.789 10 12 10C14.211 10 16 8.211 16 6C16 3.789 14.211 2 12 2ZM8 11C6.344 11 5 12.344 5 14V16C5 17.656 6.344 19 8 19H16C17.656 19 19 17.656 19 16V14C19 12.344 17.656 11 16 11H8Z",
      },
    ],
    class: "mt-1 size-5 flex-shrink-0",
    width: 24,
